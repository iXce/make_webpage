...
if __name__ == "__main__":
    ...
    parser.add_option("--allthumbs", action = "store_true", dest = "allthumbs", default = False)
    parser.add_option("--thumbwidth", type = "int", dest = "thumbwidth", default = None)
    parser.add_option("--thumbheight", type = "int", dest = "thumbheight", default = None)
